clubfinder form - Terms and conditions (see the website: http://www.binpress.com/license/view/l/bc32d35092b37eaa9bb84ea9d434a8ca)

Preamble: This Agreement, signed on Oct 30, 2017 (hereinafter: Effective Date) governs the relationship between Fanyo Siliadin, a Business Entity, (hereinafter: Licensee) and Fanyo Siliadin, a private person whose principal place of business is 29 bis boulevard gallieni (hereinafter: Licensor). This Agreement sets the terms, rights, restrictions and obligations on using clubfinder form (hereinafter: The Software) created and owned by Licensor, as detailed herein

License Grant: Licensor hereby grants Licensee a Personal, Non-assignable & non-transferable, Pepetual, Non-commercial, Without the rights to create derivative works, Non-exclusive license, all with accordance with the terms set forth and other legal restrictions set forth in 3rd party software used while running Software. 2.1. Limited: Licensee may use Software for the purpose of: 2.1.1 Running Software on Licensee’s Website[s] and Server[s]; 2.1.2 Allowing 3rd Parties to run Software on Licensee’s Website[s] and Server[s]; 2.1.3 Publishing Software’s output to Licensee and 3rd Parties; 2.1.4 Distribute verbatim copies of Software’s output (including compiled binaries); 2.1.5 Modify Software to suit Licensee’s needs and specifications.
...
2.6 With Attribution Requirements﻿: https://github.com/fsiliadin/
...
3.1 exported The Software to any jurisdiction where licensor may not enforce his rights under this agreements in; or
